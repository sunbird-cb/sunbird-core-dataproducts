...
object DashboardSyncModel extends AbsDashboardModel {
  ...
  def dashboardRedisUpdates(orgRoleCount: DataFrame, userDF: DataFrame, allCourseProgramDetailsWithRatingDF: DataFrame,
    ...
    Redis.dispatchDataFrame[Long]("live_course_program_enrolment_count", liveCourseProgramEnrollmentCountsDF, "courseID", "enrolmentCount")
    show(liveCourseProgramEnrollmentCountsDF, "EnrolmentCounts")
