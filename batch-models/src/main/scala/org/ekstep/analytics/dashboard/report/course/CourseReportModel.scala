  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    val df_warehouse = fullDF
      ...
      .select(
        ...
        col("courseBatchStartDate").alias("batch_start_date"),
        col("courseBatchEndDate").alias("batch_end_date"),
        //date_format(col("courseBatchStartDate"), "dd/MM/yyyy HH:mm:ss a").alias("batch_start_date"),
        //date_format(col("courseBatchEndDate"), "dd/MM/yyyy HH:mm:ss a").alias("batch_end_date"),
        col("courseDuration").alias("content_duration"),
        col("rating").alias("content_rating"),
        //col("courseLastPublishedOn").alias("last_published_on"),
        date_format(col("courseLastPublishedOn"), "dd/MM/yyyy HH:mm:ss a").alias("last_published_on"),
        col("ArchivedOn").alias("content_retired_on"),
        //date_format(col("ArchivedOn"), "dd/MM/yyyy HH:mm:ss a").alias("content_retired_on"),
        col("courseStatus").alias("content_status"),
