...
object TestUtil extends Serializable {
  ...
  def testModelConfig(): Map[String, AnyRef] = {
    ...
    val modelParams = Map(
      ...
      "surveyQuestionReportColumnsConfig" -> """{"reportColumns":{"createdBy":"UUID","organisationName":"Organisation Name","organisationId":"Organisation Id","surveyName":"Survey Name","surveyId":"Survey Id","surveySubmissionId":"Survey Submission Id","questionExternalId":"Question External Id","questionName":"Question","questionResponseLabel":"Answer"},"userProfileColumns":{"maskedPhone":"Masked Phone","firstName":"First Name","profileDetails-academics-nameOfQualification":"Academics Qualification","profileDetails-academics-type":"Academics Type","last_login":"Last Login"},"sortingColumns":"UUID,First Name,Masked Phone,Organisation Name,Organisation Id,Survey Name,Survey Id,Survey Submission Id,Question External Id,Question,Answer,Academics Qualification,Academics Type,Last Login"}""",
      "surveyStatusReportColumnsConfig" -> """{"reportColumns":{"createdBy":"UUID","completedDate":"Submission Date","createdAt":"Survey Started Date","organisationName":"Organisation Name","solutionExternalId":"Solution External Id","solutionId":"Solution Id","solutionName":"Solution Name","surveyName":"Survey Name","surveyId":"Survey Id","surveySubmissionId":"Survey Submission Id"},"userProfileColumns":{"firstName":"First Name"},"sortingColumns":"UUID,First Name,Organisation Name,Solution External Id,Solution Id,Solution Name,Survey Name,Survey Id,Survey Submission Id,Survey Started Date,Submission Date"}""",
