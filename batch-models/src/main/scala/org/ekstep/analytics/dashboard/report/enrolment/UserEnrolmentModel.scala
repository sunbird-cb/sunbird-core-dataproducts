  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    val warehouseDF = df
      ...
      .select(
        ...
        col("completionPercentage").alias("content_progress_percentage"),
        //col("completedOn").alias("completed_on"),
        date_format(col("completedOn"), "dd/MM/yyyy HH:mm:ss a").alias("last_accessed_on"),
        date_format(col("firstCompletedOn"), "dd/MM/yyyy HH:mm:ss a").alias("first_completed_on"),
        col("Certificate_Generated").alias("certificate_generated"),
        //col("certificate_generated_on"),
        date_format(col("certificate_generated_on"), "dd/MM/yyyy HH:mm:ss a"),
        col("userRating").alias("user_rating"),
        col("courseProgress").alias("resource_count_consumed"),
        //col("enrolledOn").alias("enrolled_on"),
        date_format(col("enrolledOn"), "dd/MM/yyyy HH:mm:ss a").alias("enrolled_on"),
